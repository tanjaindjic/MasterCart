...
public class ProductPictureTask  extends AsyncTask<Object, Void, Boolean> {
    ...
    protected Boolean doInBackground(Object... objects) {
        ...
        try {
            response = restTemplate.exchange(MainActivity.URL+"uploadProduct", HttpMethod.POST, requestEntity, String.class);
