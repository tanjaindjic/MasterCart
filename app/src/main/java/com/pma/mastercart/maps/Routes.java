...
public class Routes
{
    ...
    {
        return "ClassPojo [summary = "+summary+", copyrights = "+copyrights+", legs = "+legs+", warnings = "+warnings+", bounds = "+bounds+", overview_polyline = "+overview_polyline+", waypoint_order = "+waypoint_order+"]";
    }
}